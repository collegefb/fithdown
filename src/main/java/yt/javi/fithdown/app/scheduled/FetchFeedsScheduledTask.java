              ...
              try {
                ...
                fetchArticlesFromUrlService
                        ...
                        .forEach(articleResponse -> {
                          ...
                          ).ifPresent(articleResponse1 ->
                                  executionResult.put(sourceResponse.getName(), executionResult.get(sourceResponse.getName()) + 1)
                          );
                        });
